...
export default function PaymentsRoutePage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl sm:text-3xl font-semibold text-[#1C2541]">{t("payments")}</h1>

      {/* Section 1: Upcoming Payments */}
      <div className="space-y-3">
        <h2 className="text-lg font-semibold text-[#1C2541]">{t("upcomingPayments")}</h2>
        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-xs divide-y divide-slate-100">
          <div className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3.5">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold text-sm text-[#1C2541] truncate">{t("motorInsuranceRenewal")}</h3>
                <p className="text-xs text-[#EA580C] font-semibold mt-0.5">{isAr ? "استحقاق 24 يوليو 2026" : "Due 24 Jul 2026"}</p>
              </div>
            </div>
            <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto pt-1 sm:pt-0 border-t border-slate-100 sm:border-t-0">
              <span className="text-sm sm:text-base font-semibold text-[#1C2541]">{isAr ? "4,200 ر.س" : "SAR 4,200"}</span>
          ...
          <div className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-slate-100 sm:border-t-0">
            <div className="flex items-center gap-3.5">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold text-sm text-[#1C2541] truncate">{t("lifeInsuranceAnnualPremium")}</h3>
                <p className="text-xs text-[#EA580C] font-semibold mt-0.5">{isAr ? "استحقاق 10 أغسطس 2026" : "Due 10 Aug 2026"}</p>
              </div>
            </div>
            <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto pt-1 sm:pt-0 border-t border-slate-100 sm:border-t-0">
              <span className="text-sm sm:text-base font-semibold text-[#1C2541]">{isAr ? "1,800 ر.س" : "SAR 1,800"}</span>
              <button className="bg-[#2563EB] hover:bg-blue-600 text-white font-semibold px-4 py-2 rounded-xl text-xs transition-colors cursor-pointer shadow-sm">
                {t("payNow")}
              </button>
            </div>
          ...
          <div className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-slate-100 sm:border-t-0">
            <div className="flex items-center gap-3.5">
              ...
              <div className="min-w-0">
                <h3 className="font-semibold text-sm text-[#1C2541] truncate">{t("travelInsuranceMultiTripPlan")}</h3>
                <p className="text-xs text-[#EA580C] font-semibold mt-0.5">{isAr ? "استحقاق 03 أكتوبر 2026" : "Due 03 Oct 2026"}</p>
              </div>
            </div>
            <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto pt-1 sm:pt-0 border-t border-slate-100 sm:border-t-0">
              <span className="text-sm sm:text-base font-semibold text-[#1C2541]">{isAr ? "1,600 ر.س" : "SAR 1,600"}</span>
              <button className="bg-[#2563EB] hover:bg-blue-600 text-white font-semibold px-4 py-2 rounded-xl text-xs transition-colors cursor-pointer shadow-sm">
                {t("payNow")}
              </button>
            </div>
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-6 border border-slate-100 shadow-xs space-y-4">
        <h2 className="text-lg font-semibold text-[#1C2541]">{t("transactionHistoryTitle")}</h2>
