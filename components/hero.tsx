...
export default function Hero({ onOpenQuoteModal }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-hero-gradient pt-6 pb-20 sm:pb-24 lg:pt-10 lg:pb-32">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="w-full lg:col-span-6 relative flex justify-center items-center order-1 lg:order-2" data-gsap="scale">

            {/* Main Hero Image */}
            <div className="relative w-[88%] sm:w-[80%] lg:w-[84%] max-w-md lg:max-w-lg mx-auto">
              <Image
                src="/images/home.png"
